...
Run and jump your way to the the yellow platform.  Keep in mind that you have
the ability to double jump.  Jump onto the zipline and your character will
automatically grab onto it.  This will will help you cross gaps that are 
too long to be crossed even with the double jump.  Simply press the jump
...
which takes advantage of python's multiple inheritance to add these convinient methods to the gameobjects.  The separation is to keep the physics code
